  ...
  return (
    <LegalPage title="Acceptable Use Policy" updatedAt="March 1, 2026">
      ...
      <Ul>
        ...
        <li>All event processing must be tied to a specific application workflow and based on documented end-user consent.</li>
        <li>Maintain accurate records of end-user consent for all application-generated events.</li>
      ...
      <Ul>
        <li>Using the platform to process unsolicited or non-consented events of any kind.</li>
        ...
        <li>Purchasing or using third-party contact lists for event processing.</li>
        <li>Reselling or redistributing API access or event processing capacity.</li>
      </Ul>
      ...
      <Ul>
        ...
        <li>Spoofing sender identities or application identifiers.</li>
      ...
      <h3 className="font-semibold text-slate-800">2.5 Telecom & Notification Abuse</h3>
      <Ul>
        <li>Providing authentication or verification services to third parties (OTP-as-a-service).</li>
        <li>Operating shared API endpoints used by multiple unrelated applications.</li>
        <li>Forwarding or relaying events on behalf of unregistered third-party services.</li>
        <li>Using the platform as an anonymous traffic relay or event proxy.</li>
        <li>Lead-generation event processing or contact list enrichment.</li>
      </Ul>
